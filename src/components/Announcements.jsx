...
const Announcements = forwardRef(function Announcements({ showCreateForm = false, theme = "light" }, ref) {
  ...
  const themeConfig = {
    light: {
      ...
      primaryColorLight: "text-green-500",
      iconColor: "text-green-600",
      modalBg: "bg-white",
      modalBorder: "border-green-200",
      inputBg: "bg-emerald-50",
      inputText: "text-emerald-700",
      inputBorder: "border-emerald-200",
      inputFocus: "focus:ring-emerald-500",
      announcementBg: "bg-green-50",
      announcementBorder: "border-green-300",
      eventBg: "bg-amber-50",
    ...
    dark: {
      buttonBg: "bg-gradient-to-r from-green-600 to-violet-600",
      buttonHover: "hover:from-green-700 hover:to-violet-700",
      buttonText: "text-white",
      borderColor: "border-green-500/50",
      primaryColor: "text-green-400",
      primaryColorLight: "text-green-300",
      ...
      announcementBorder: "border-green-500",
